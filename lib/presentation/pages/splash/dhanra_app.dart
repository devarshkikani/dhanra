...
import 'package:dhanra/presentation/pages/splash/splash_screen.dart';
...
class DhanraApp extends StatefulWidget {
  ...
  @override
  State<DhanraApp> createState() => _DhanraAppState();

  static _DhanraAppState? of(BuildContext context) =>
      context.findAncestorStateOfType<_DhanraAppState>();
}

class _DhanraAppState extends State<DhanraApp> {
