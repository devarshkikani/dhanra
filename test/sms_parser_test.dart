    ...
    test('Test all messages in smsList', () {
      ...
      final expected = [
        ...
        }, // 8 SBI NEFT
        {
          'amount': '77500.00',
          'type': 'Debit',
          'merchant': 'Manu Kikani'
        }, // 9 SBI NEFT
        {
          'amount': '12345.00',
          'type': 'Credit',
          'merchant': 'SMART SHIP HUB DIGITAL INDIA'
        }, // 10 HDFC
        {
          'amount': '3000.00',
          'type': 'Debit',
          'merchant': 'SARVESH RAJENDRA RANSUBHE'
        }, // 11 HDFC
        {
          'amount': '4655.00',
          'type': 'Debit',
          'merchant': 'IDFCFIRSTBANKLIMITE'
        }, // 12 Kotak
        {
          'amount': '99000.00',
          'type': 'Credit',
        ...
        }, // 13 Axis
        {
          'amount': '2000.00',
          'type': 'Credit',
          'merchant': 'PM KISAN SAMMAN NIDHI YOJNA'
        }, // 14 SUDICO
        {
          'amount': '200000.00',
          'type': 'Credit',
      ...
      for (int i = 0; i < results.length; i++) {
        ...
        if (kDebugMode) {
          ...
          print(
              'Actual:   Amt: ${res['amount']}, Type: ${res['type']}, Merchant: ${res['upiIdOrSenderName']}');
          print(
              'Expected: Amt: ${exp['amount']}, Type: ${exp['type']}, Merchant: ${exp['merchant']}');
        }
      }
